...
router.get('/categorie-entretiens/statut-min/:statut', authorizeRoles('manager','client','mecanicien'), categorieEntretienController.getAllCategorieEntretienByStatutWithMinPrice);
